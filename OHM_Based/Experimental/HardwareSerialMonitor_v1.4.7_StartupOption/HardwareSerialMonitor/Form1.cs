...
namespace HardwareSerialMonitor
{
    public partial class Form1 : Form
    {
        ...
        {
            // --- Begin: Added "Run at Startup" option ---
            ...
            // --- End: Added "Run at Startup" option ---
        ...
        private string getVidPid(string port)
        {
            ...
            foreach (ManagementObject QueryObj in searcher.Get())
            {
                ...
                if (deviceName.Contains(port))
                {
                    ...
                    {
                        Int32 indexOfVIDPID = sPortDeviceID.IndexOf("VID");
        ...
        private string getDeviceID(string port)
        {
            ...
            foreach (ManagementObject QueryObj in searcher.Get())
            {
                ...
                if (deviceName.Contains(port))
                {
                    ...
                    {
                        Int32 indexOfVIDPID = deviceID.IndexOf("VID");
        ...
        // --- New methods for Run at Startup ---
