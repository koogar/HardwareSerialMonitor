        ...
        private void dataCheck()//function overload with 0 arguments, called when a with the default serial port on a timer
        {
            ...
            */
            ...
            string stats =  string.Empty;//create a new string and instantiate it as empty
                ...
                //stats = "C" + cpuTemp + "c " + cpuLoad + "%|G" + gpuTemp + "c " + gpuLoad + "%|R" + ramUsed + "GB|RA" + ramAvailable + "GB|RL" + ramLoad + "%|GMT" + gpuMemTotal + "GB|";
                //stats = "C" + cpuTemp + "c " + cpuLoad + "%|G" + gpuTemp + "c " + gpuLoad + "%|R" + ramUsed + "GB|RA" + ramAvailable + "GB|RL" + ramLoad + "%|GMT" + gpuMemTotal + "MB|GML" + gpuMemLoad + "%|GFANL" + gpuFanSpeedLoad + "%|GPWR" + gpuPower + "W|GMU" + gpuMemUsed + "MB|"; //"MB|GRPM" + gpuFanSpeedRPM + "RPM|CFANL" + CpuFanSpeedLoad + "%|";  //  write the strings to the new string along with separators and denotations the arduino can understand
